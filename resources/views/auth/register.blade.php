<x-layout>
    <div class="bg-white rounded-lg shadow-md w-full md:max-w-xl mx-auto mt-12 p-8 py12">
        ...
        <form action="{{route('register.store')}}" method="POST">
            ...
            <button type="submit" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded focus:outline-none">Зарегистрироваться</button>
            <p class="mt-4 text-gray-400">
                Уже есть аккаунт?
                <a class="text-blue-900 hover:underline" href="{{route('login')}}">Войти здесь</a>
            </p>
        </form>
    </div>
</x-layout>